...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/skills-view',         title: 'Assess Critical Skills',        icon:'nc-bulb-63',    class: '' , userType: true },
    ...
    { path: '/MyTeamsProfile',          title: 'My Teams Profiles',     icon: 'nc-bank',  class: ''  , userType: true},  
