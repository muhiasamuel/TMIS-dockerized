...
export class HttpServiceService {
  ...
  serverUrl: string = 'http://172.16.10.233:8080/v1/api/';
  ...
  getAllSuccessionPlans(): Observable<any> {
    const apiUrl = `${this.serverUrl}succession-plans/getall/succession-plans`;
...
addPerformance(data:any,pf:number): Observable<any>{
  // http://192.168.91.51:8080/v1/api/performances/add-for-user/256
